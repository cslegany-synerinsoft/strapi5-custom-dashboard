...
function IframeResizer(props: IframeResizerProps & { forwardRef?: any }) {
  ...
  const iframeRef = useRef<{ iframeResizer: any }>(null);
  ...
  useImperativeHandle(forwardRef, () => ({
    ...
    moveToAnchor: (anchor: any) => iframeRef.current?.iframeResizer.moveToAnchor(anchor),
    sendMessage: (message: any, targetOrigin: any) => {
      iframeRef.current?.iframeResizer.sendMessage(message, targetOrigin);
    }
  }));

  return <iframe {...filteredProps} ref={iframeRef as any} />;
}
